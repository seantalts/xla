...
// CHECK-DAG: %[[SRC:.*]] = builtin.unrealized_conversion_cast %{{.*}} : tensor<4x8xf32> to vector<4x8xf32>
...
// CHECK-DAG: %[[CST:.*]] = arith.constant dense<0.000000e+00> : vector<2x4xf32>
// CHECK-DAG: %[[CAST:.*]] = builtin.unrealized_conversion_cast %{{.*}} : tensor<8x16xf32> to vector<8x16xf32>
